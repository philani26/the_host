...
/* Image paths are stored root-relative ("https://firebasestorage.googleapis.com/v0/b/utmost-trips-aaae0.firebasestorage.app/o/uploads%2Fdefault-1.jpeg?alt=media") to match the public
...
const HU_ABOUT_DEFAULTS = {
  ...
  storyImage: 'https://firebasestorage.googleapis.com/v0/b/utmost-trips-aaae0.firebasestorage.app/o/uploads%2Fdefault-9.jpeg?alt=media',
  ...
  founderImage: 'https://firebasestorage.googleapis.com/v0/b/utmost-trips-aaae0.firebasestorage.app/o/uploads%2Fdefault-2.jpeg?alt=media',
...
const HU_EXPERIENCES_DEFAULTS = {
  ...
  categories: [
    { tag: '01 · International Travel', heading: 'International Travel', text: 'Curated group trips to destinations across Africa and beyond — thoughtfully planned itineraries, trusted local partners, and a community of women to share it all with.', image: 'https://firebasestorage.googleapis.com/v0/b/utmost-trips-aaae0.firebasestorage.app/o/uploads%2Fdefault-18.jpeg?alt=media' },
    { tag: '02 · Local Escapes', heading: 'Local Escapes', text: "Weekend getaways, scenic road trips and local experiences that prove you don't need a passport to feel far away — just good company and a beautiful destination.", image: 'https://firebasestorage.googleapis.com/v0/b/utmost-trips-aaae0.firebasestorage.app/o/uploads%2Fdefault-13.jpeg?alt=media' },
    { tag: '03 · Staycations & Retreats', heading: 'Staycations & Retreats', text: 'Beautiful local escapes designed for rest, connection and a little luxury — think slow mornings, tastings, and spaces made for exhaling.', image: 'https://firebasestorage.googleapis.com/v0/b/utmost-trips-aaae0.firebasestorage.app/o/uploads%2Fdefault-24.jpeg?alt=media' },
    { tag: '04 · Events & Experiences', heading: 'Events & Experiences', text: 'Social gatherings, tastings and celebrations that bring the community together — the moments between the trips, where the friendships really grow.', image: 'https://firebasestorage.googleapis.com/v0/b/utmost-trips-aaae0.firebasestorage.app/o/uploads%2Fdefault-17.jpeg?alt=media' }
  ],
  ...
  destinations: [
    { image: 'https://firebasestorage.googleapis.com/v0/b/utmost-trips-aaae0.firebasestorage.app/o/uploads%2Fdefault-13.jpeg?alt=media', tag: 'Local Escape', label: 'Mpumalanga' },
    { image: 'https://firebasestorage.googleapis.com/v0/b/utmost-trips-aaae0.firebasestorage.app/o/uploads%2Fdefault-18.jpeg?alt=media', tag: 'Local Escape', label: 'Kruger National Park' },
    { image: 'https://firebasestorage.googleapis.com/v0/b/utmost-trips-aaae0.firebasestorage.app/o/uploads%2Fdefault-21.jpeg?alt=media', tag: 'Local Escape', label: 'Hartbeespoort' },
    { image: 'https://firebasestorage.googleapis.com/v0/b/utmost-trips-aaae0.firebasestorage.app/o/uploads%2Fdefault-6.jpeg?alt=media', tag: 'Local Escape', label: 'Drakensberg' },
    { image: 'https://firebasestorage.googleapis.com/v0/b/utmost-trips-aaae0.firebasestorage.app/o/uploads%2Fdefault-7.jpeg?alt=media', tag: 'Local Escape', label: 'Durban' },
    { image: 'https://firebasestorage.googleapis.com/v0/b/utmost-trips-aaae0.firebasestorage.app/o/uploads%2Fdefault-9.jpeg?alt=media', tag: 'Local Escape', label: 'Cape Town' },
    { image: 'https://firebasestorage.googleapis.com/v0/b/utmost-trips-aaae0.firebasestorage.app/o/uploads%2Fdefault-8.jpeg?alt=media', tag: 'Local Escape', label: 'Lesotho' },
    { image: 'https://firebasestorage.googleapis.com/v0/b/utmost-trips-aaae0.firebasestorage.app/o/uploads%2Fdefault-24.jpeg?alt=media', tag: 'Retreat', label: 'Retreats & Staycations' }
  ],
  ...
  conciergeImage: 'https://firebasestorage.googleapis.com/v0/b/utmost-trips-aaae0.firebasestorage.app/o/uploads%2Fdefault-11.jpeg?alt=media',
  ...
  ctaImage: 'https://firebasestorage.googleapis.com/v0/b/utmost-trips-aaae0.firebasestorage.app/o/uploads%2Fdefault-9.jpeg?alt=media'
};
...
const HU_HOME_DEFAULTS = {
  ...
  localImage: 'https://firebasestorage.googleapis.com/v0/b/utmost-trips-aaae0.firebasestorage.app/o/uploads%2Fdefault-21.jpeg?alt=media',
...
const HU_DEFAULT_MEDIA_LIBRARY = [
  "https://firebasestorage.googleapis.com/v0/b/utmost-trips-aaae0.firebasestorage.app/o/uploads%2Fdefault-1.jpeg?alt=media",
  "https://firebasestorage.googleapis.com/v0/b/utmost-trips-aaae0.firebasestorage.app/o/uploads%2Fdefault-2.jpeg?alt=media",
  "https://firebasestorage.googleapis.com/v0/b/utmost-trips-aaae0.firebasestorage.app/o/uploads%2Fdefault-3.jpeg?alt=media",
  "https://firebasestorage.googleapis.com/v0/b/utmost-trips-aaae0.firebasestorage.app/o/uploads%2Fdefault-4.jpeg?alt=media",
  "https://firebasestorage.googleapis.com/v0/b/utmost-trips-aaae0.firebasestorage.app/o/uploads%2Fdefault-5.jpeg?alt=media",
  "https://firebasestorage.googleapis.com/v0/b/utmost-trips-aaae0.firebasestorage.app/o/uploads%2Fdefault-6.jpeg?alt=media",
  "https://firebasestorage.googleapis.com/v0/b/utmost-trips-aaae0.firebasestorage.app/o/uploads%2Fdefault-7.jpeg?alt=media",
  "https://firebasestorage.googleapis.com/v0/b/utmost-trips-aaae0.firebasestorage.app/o/uploads%2Fdefault-8.jpeg?alt=media",
  "https://firebasestorage.googleapis.com/v0/b/utmost-trips-aaae0.firebasestorage.app/o/uploads%2Fdefault-9.jpeg?alt=media",
  "https://firebasestorage.googleapis.com/v0/b/utmost-trips-aaae0.firebasestorage.app/o/uploads%2Fdefault-10.jpeg?alt=media",
  "https://firebasestorage.googleapis.com/v0/b/utmost-trips-aaae0.firebasestorage.app/o/uploads%2Fdefault-11.jpeg?alt=media",
  "https://firebasestorage.googleapis.com/v0/b/utmost-trips-aaae0.firebasestorage.app/o/uploads%2Fdefault-13.jpeg?alt=media",
  "https://firebasestorage.googleapis.com/v0/b/utmost-trips-aaae0.firebasestorage.app/o/uploads%2Fdefault-15.jpeg?alt=media",
  "https://firebasestorage.googleapis.com/v0/b/utmost-trips-aaae0.firebasestorage.app/o/uploads%2Fdefault-16.jpeg?alt=media",
  "https://firebasestorage.googleapis.com/v0/b/utmost-trips-aaae0.firebasestorage.app/o/uploads%2Fdefault-17.jpeg?alt=media",
  "https://firebasestorage.googleapis.com/v0/b/utmost-trips-aaae0.firebasestorage.app/o/uploads%2Fdefault-18.jpeg?alt=media",
  "https://firebasestorage.googleapis.com/v0/b/utmost-trips-aaae0.firebasestorage.app/o/uploads%2Fdefault-19.jpeg?alt=media",
  "https://firebasestorage.googleapis.com/v0/b/utmost-trips-aaae0.firebasestorage.app/o/uploads%2Fdefault-20.jpeg?alt=media",
  "https://firebasestorage.googleapis.com/v0/b/utmost-trips-aaae0.firebasestorage.app/o/uploads%2Fdefault-21.jpeg?alt=media",
  "https://firebasestorage.googleapis.com/v0/b/utmost-trips-aaae0.firebasestorage.app/o/uploads%2Fdefault-22.jpeg?alt=media",
  "https://firebasestorage.googleapis.com/v0/b/utmost-trips-aaae0.firebasestorage.app/o/uploads%2Fdefault-23.jpeg?alt=media",
  "https://firebasestorage.googleapis.com/v0/b/utmost-trips-aaae0.firebasestorage.app/o/uploads%2Fdefault-24.jpeg?alt=media"
];
...
const HU_NAV = [
  ...
  { key:'experiences', href:'experiences.html', label:'Experiences Page', group:'Content', icon:'<path d="M3 11l18-8-8 18-2-8-8-2z"/>' },
